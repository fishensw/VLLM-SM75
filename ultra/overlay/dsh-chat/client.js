window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".lats3W_row{border-bottom:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.lats3W_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.lats3W_title{color:var(--dsw-alias-label-primary);font-size:calc(14px * var(--dsh-font-scale,1));font-weight:400;line-height:calc(22px * var(--dsh-font-scale,1))}.lats3W_desc{color:var(--dsw-alias-label-tertiary);font-size:calc(12px * var(--dsh-font-scale,1));font-weight:400;line-height:calc(18px * var(--dsh-font-scale,1))}.lats3W_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:calc(14px * var(--dsh-font-scale,1));line-height:calc(22px * var(--dsh-font-scale,1));display:inline-flex}.lats3W_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.lats3W_chevron{flex:none}";
					...
					inject: (sessionId) => {
						...
						return {
							...
							openFile: async (path, options) => {
								...
								ctx.sidebarRight.openResourceIn(sessionId, url, options?.line === void 0 ? {} : { params: { line: options.line } });
