		...
		*/
		...
		var SidebarRightController = class {
			...
			*/
			...
			require() {
				if (this.binding === void 0) {
					const last = [...this.adopted.entries()].at(-1);
					if (last !== void 0) return { sessionId: last[0], actions: last[1].store.actions };
				}
