window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$2 = "._93YTAG_summary{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:8px;margin-left:8px;font-size:calc(12px * var(--dsh-font-scale,1));display:flex}._93YTAG_summary>:first-child{flex-shrink:0}._93YTAG_paths{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._93YTAG_output{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:8px 0;padding:12px;font-size:calc(12px * var(--dsh-font-scale,1))}._93YTAG_inspect{color:var(--dsw-alias-link);font:inherit;cursor:pointer;background:0 0;border:none;align-self:flex-start;padding:4px 0;font-size:calc(12px * var(--dsh-font-scale,1))}";
		...
		*/
		...
		const css = ".nyYjTG_root{--deliverable-fill:var(--dsw-static-neutral-50);--deliverable-hover:var(--dsw-static-neutral-100);flex-direction:column;gap:16px;min-width:0;margin-top:4px;display:flex;container-type:inline-size}.nyYjTG_root[data-after-produced-files=true]{margin-top:0}body[data-ds-dark-theme] .nyYjTG_root{--deliverable-fill:var(--dsw-static-neutral-850);--deliverable-hover:var(--dsw-static-neutral-800)}.nyYjTG_hostStatus{color:var(--dsw-alias-label-secondary);align-items:center;gap:8px;font-size:calc(12px * var(--dsh-font-scale,1));line-height:calc(18px * var(--dsh-font-scale,1));display:flex}.nyYjTG_presented{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;min-width:0;display:grid}.nyYjTG_presented[data-single=true]{grid-template-columns:minmax(0,1fr)}.nyYjTG_file{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l1);background:var(--deliverable-fill);min-width:0;height:60px;color:var(--dsw-alias-label-primary);border-radius:18px;align-items:center;gap:10px;padding:8px 10px;transition:background-color .12s;display:flex;position:relative;overflow:hidden}.nyYjTG_file:hover{background:var(--deliverable-hover)}.nyYjTG_cardPreview{z-index:1;border-radius:inherit;cursor:pointer;background:0 0;border:0;width:100%;padding:0;position:absolute;inset:0}.nyYjTG_cardPreview:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-brand-primary);outline:none}.nyYjTG_fileIcon{z-index:2;box-sizing:border-box;pointer-events:none;border:.5px solid var(--dsw-alias-border-l1);background:var(--deliverable-fill);width:40px;height:40px;color:var(--dsw-alias-link);border-radius:10px;flex:none;place-items:center;display:grid;position:relative;overflow:hidden}.nyYjTG_fileBody{z-index:2;pointer-events:none;flex:1;justify-content:space-between;align-items:center;gap:12px;min-width:0;display:flex;position:relative}.nyYjTG_details{flex-direction:column;flex:1;justify-content:center;gap:2px;min-width:0;display:flex}.nyYjTG_fileName{text-overflow:ellipsis;white-space:nowrap;font-size:calc(13px * var(--dsh-font-scale,1));font-weight:500;line-height:calc(20px * var(--dsh-font-scale,1));overflow:hidden}.nyYjTG_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:calc(10px * var(--dsh-font-scale,1));font-weight:400;line-height:calc(16px * var(--dsh-font-scale,1));overflow:hidden}.nyYjTG_description[data-error=true]{color:var(--dsw-alias-state-error-primary)}.nyYjTG_previewHint,.nyYjTG_file:hover .nyYjTG_secondaryText{display:none}.nyYjTG_file:hover .nyYjTG_previewHint{display:inline}.nyYjTG_split{box-sizing:border-box;pointer-events:auto;border:.5px solid var(--dsw-alias-border-l3);background:var(--dsw-alias-button-floating-fill);border-radius:10px;flex:none;align-items:stretch;height:28px;display:inline-flex;overflow:hidden}.nyYjTG_menuAnchor{align-self:stretch}.nyYjTG_open,.nyYjTG_chevron{color:var(--dsw-alias-label-primary);cursor:pointer;font-family:var(--dsw-font-family);background:0 0;border:0;justify-content:center;align-items:center;display:inline-flex}.nyYjTG_open{padding:4px 8px;font-size:calc(12px * var(--dsh-font-scale,1));line-height:calc(18px * var(--dsh-font-scale,1))}.nyYjTG_chevron{border-left:.5px solid var(--dsw-alias-border-l3);color:var(--dsw-alias-label-secondary);padding:4px 5px}.nyYjTG_open:hover,.nyYjTG_open:focus-visible,.nyYjTG_chevron:hover:not(:disabled),.nyYjTG_chevron:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.nyYjTG_chevron:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.nyYjTG_menuActionIcon{width:16px;height:16px;display:block}.nyYjTG_toggle{min-width:0;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:8px;align-self:center;align-items:center;gap:4px;padding:1px 11px;font-size:calc(12px * var(--dsh-font-scale,1));line-height:calc(18px * var(--dsh-font-scale,1));display:inline-flex}.nyYjTG_toggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.nyYjTG_toggle svg{flex:none;width:14px;height:14px}@container (width<=620px){.nyYjTG_presented{grid-template-columns:minmax(0,1fr)}}@media (pointer:coarse){.nyYjTG_split{min-height:44px}.nyYjTG_open,.nyYjTG_chevron{min-width:44px}}";
		...
		/** Download one workspace file through the console's streaming route. */
		function downloadWorkspaceFile(absolutePath) {
			const a = document.createElement("a");
			a.href = "/console-api/workspace-file?path=" + encodeURIComponent(absolutePath);
			a.download = "";
		...
		*/
		function PresentedFileCard({ file, cwd, phase, host, onPreview, onAction, t }) {
			...
			const menuDisabled = phase === "opening" || phase === "revealing";
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("button", {
								...
								onSelect: (id) => {
									if (id === "download") { downloadWorkspaceFile(resolveWorkspacePath(cwd, file.path)); return; }
