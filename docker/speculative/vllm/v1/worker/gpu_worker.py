...
class Worker(WorkerBase):
    ...
    def get_draft_attn_layer_names(self) -> list[str]:
        """Report the loaded drafter's layer names for cache-group annotation."""
        speculator = getattr(self.model_runner, "speculator", None)
        return sorted(getattr(speculator, "draft_attn_layer_names", ()))
