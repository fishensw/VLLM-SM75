...
def get_draft_quant_config(vllm_config: VllmConfig) -> "QuantizationConfig | None":
    ...
    if quant_config is not None:
        # Draft construction bypasses initialize_model(), which normally sets
        # packed_modules_mapping and the checkpoint-to-module name mapper.
        # See upstream PR #53122. Import lazily to avoid the loader/model cycle.
